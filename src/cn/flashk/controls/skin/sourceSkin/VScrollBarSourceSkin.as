package cn.flashk.controls.skin.sourceSkin
{
	...
	{
		public static var topBottomButtonPosX:int = 1;
		public static var scrollerXLess:int = 1;
		...
		public function VScrollBarSourceSkin(skinSet:ScrollBarSkinSet)
		{
			...
			bar.addChild(bpBG);
			bpT.x = topBottomButtonPosX;
			bpB.x = topBottomButtonPosX;
		}
		...
		override public function reDraw():void {
			...
			bp.height = height;
			bp.width = tar.compoWidth-scrollerXLess*2;
			bp.x = scrollerXLess;
