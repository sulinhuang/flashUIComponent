package cn.flashk.controls
{
	...
	public class List extends UIComponent
	{
		...
		public function List(skinSet:ScrollBarSkinSet=null)
		{
			...
			scrollBar.initMouseOverOut(this);
			...
			scrollBar.addMouseWheelScroll(this);
		}
		...
		public function set isNeedUpdate(value:Boolean):void
		{
			_isNeedUpdate = value;
		}
        ...
        override public function hideSkin(isHide:Boolean=true):void
        {
            ...
            {
				if(isHide == true){
               	 	SourceSkin(skin).sc9Bitmap.alpha = 0;
				}else{
					SourceSkin(skin).sc9Bitmap.alpha = 1;
				}
				
            }
        }
		
		public function getSkinBitmap():DisplayObject
		{
			return SourceSkin(skin).sc9Bitmap;
		}
		...
		{
			return addItemAt(item,items.numChildren);
		}
		/**
		...
		public function reAlignAnyway():void
		{
			_isNeedUpdate  = true;
			reAlign();
		}
		public function reAlign(event:Event=null):void
		{
		...
		public var isResetScrollbarPostion:Boolean = true;
		public function removeAll():void
		{
			if(isResetScrollbarPostion){
			scrollBar.scrollToPosition(0);
		...
		public var isRemoveItems:Boolean = true;
		...
		public var isResetTarget:Boolean = true;
