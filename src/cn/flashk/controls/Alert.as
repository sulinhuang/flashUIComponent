package cn.flashk.controls
{
    ...
    public class Alert extends Window
    {
		...
		private var _checkBoxFun:Function;
         ...
         */
        public function Alert(text:String , title:String , icon:Object , buttonLabels:Array , closeFunction:Function , alertWidth:Number = 0,isCheckBox:Boolean=false,checkBoxFun:Function=null,checkLb:String ="")
        {
            super ();
            _tf2 = new TextFormat ();
			...
			if(isCheckBox)
			{
				...
				_checkBox.label = checkLb;
				_checkBox.x= (this.width -_checkBox.width)/2;
				_checkBox.y= btn.y -26;
				_checkBoxFun =checkBoxFun;
				_checkBox.addEventListener(Event.CHANGE,onSelectd);
...
//			closeBtn.toolTip = "关闭消息";
        ...
        override public function close(event:Event = null):void
        {
            ...
            if (event != null)
            {
				...
				if (_checkBoxFun != null)
				{
					_checkBoxFun (_selected);
				}
         ...
         */
        public static function show(text:String , parentContainer:DisplayObjectContainer =null, closeFunction:Function = null , title:String = "消息" , icon:Object = null , buttonLabels:Array = null , isUnableMouse:Boolean = true , alertWidth:Number = 0,isCheckBox:Boolean=false,checkBoxFun:Function=null,checkLB:String=""):Alert
        {
            if (buttonLabels == null)
                buttonLabels = sureLabels;
			if(parentContainer==null) parentContainer = UIComponent.stage;
            var alert:Alert = new Alert (text , title , icon , buttonLabels , closeFunction , alertWidth,isCheckBox,checkBoxFun,checkLB);
